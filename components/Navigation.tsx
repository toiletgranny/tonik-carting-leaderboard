            ...
            <div ref={containerRef} className="relative flex items-center justify-center overflow-hidden p-[8px] rounded-inherit">
              ...
              <Link href="/" onClick={() => handleTabClick('leaderboard')}>
                ...
                >
                  ...
                  <span className={`text-body-default text-center leading-[24px] ${activeTab === 'leaderboard' ? 'text-content-strong' : 'text-content-default group-hover:text-content-strong'}`}>
                    Leaderboard
                  </span>
                </button>
              </Link>
              <Link href="/events" onClick={() => handleTabClick('events')}>
                ...
                >
                  ...
                  <span className={`text-body-default text-center leading-[24px] ${activeTab === 'events' ? 'text-content-strong' : 'text-content-default group-hover:text-content-strong'}`}>
                    Events
                  </span>
                </button>
              </Link>
